    ...
    <Layout title="Zubayr Ali">
      <>
        ...
        <div className="resume-2">
          ...
          <p>
            My name is Zubayr Ali, I'm a {new Date().getFullYear() - 1999} old
            Web Developer. I work on Front-end technologies such as JS, ReactJs,
            Gatsby, etc. I enjoy learning different technologies and creating
            something useful out of it every so often. <br /> I've a bachelor's
            degree in computer science. I am a Blockchain, Cyber security, FOSS
          ...
          <a
            href="https://stackshare.io/zubayrrr/main-stack"
            target="_blank"
